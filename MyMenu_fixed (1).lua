...
-- Key window box (NEXUS V1.0 style)
...
-- Key box title bar (drag handle - title area lang)
...
-- Close button (top right ng title bar)
...
-- Hover effect on submit (NEXUS V1.0 style)
