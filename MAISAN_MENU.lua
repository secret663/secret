...
local topTabNames = {
	...
	"MAISAN MENU", "THE BILLIONARE", "RP TELEPORT", "ADMIN PANEL", "REMOTES"
...
local function addMainMenuButton(text, callback)
	...
	local panel = allTabPanels["MAISAN MENU"]
...
addMainMenuButton("REMOTES", function()

	-- MAISAN REMOTE SPY v3
...
addLog("✅ MAISAN REMOTE SPY LOADED")
