...
new("UIStroke", {Color = Color3.fromRGB(40, 40, 40), Thickness = 1, Parent = main})

-- Falling dots
local function spawnFallingDot()
	local s = ({3,4,5})[math.random(1,3)]
...
task.spawn(function()
	while true do task.wait(math.random(3,7)/10) spawnFallingDot() end
end)
...
-- bottom fill to remove rounded corners at bottom of header
new("Frame", {
...
new("UICorner", {CornerRadius = UDim.new(0,8), Parent = headerBar})
...
-- ============================================
-- LEFT PANEL - Scrollable vertical category buttons (RAZE style)
-- ============================================
...
-- right fill strip to remove gap
new("Frame", {
...
-- Thin divider line between left and right
new("Frame", {
...
local rightPanel = new("Frame", {
	Name = "RightPanel",
	Size = UDim2.new(1, -111, 1, -30),
	Position = UDim2.new(0, 111, 0, 30),
	BackgroundColor3 = Color3.fromRGB(0, 0, 0),
	BorderSizePixel = 0,
	Parent = main,
	ZIndex = 2,
...
local allTabNames = {
	...
	"ANTI CHEAT", "PLAYER LIST", "SETTINGS", "LUA EXECUTOR"
}

-- Short names for left panel buttons
local shortNames = {
	["MAIN MENU"] = "MAIN",
	["ROLEPLAY MENU"] = "ROLEPLAY",
	["ROLEPLAY MENU 2"] = "ROLEPLAY 2",
...
local function createCategory(fullName)
	local shortName = shortNames[fullName] or fullName
	...
	-- Content panel inside right panel
	...
	new("UIListLayout", {Parent = panel, Padding = UDim.new(0, 5)})
	...
	btn.MouseButton1Click:Connect(function()
		...
		if currentCategoryBtn then
			currentCategoryBtn.BackgroundColor3 = Color3.fromRGB(15, 15, 15)
	...
	table.insert(allCategoryBtns, btn)
	return panel
end
...
if allCategoryBtns[1] then
	allCategoryBtns[1].BackgroundColor3 = Color3.fromRGB(30, 30, 30)
	allCategoryBtns[1].TextColor3 = Color3.fromRGB(255, 255, 255)
	currentCategoryBtn = allCategoryBtns[1]
end
showTab("MAIN MENU")

-- Keep backward compat: allTabButtons used later in script
local allTabButtons = allCategoryBtns

-- Theme system (kept for settings tab compatibility)
...
local function applyTheme()
	-- kept so settings tab doesn't error
end
