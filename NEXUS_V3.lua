...
local function onKeySubmit()
	...
	if keyBox.Text == CorrectKey then
		...
		-- Solid black bg so NEXUS GUI behind is hidden during loading
		...
		task.spawn(function()
			...
			local progressTween = TweenService:Create(ProgressFill, TweenInfo.new(4.5, Enum.EasingStyle.Linear), {Size = UDim2.new(1, 0, 1, 0)})
			progressTween:Play()

			task.spawn(function()
				while ProgressFill.Parent do
					Shine.Position = UDim2.new(-0.25, 0, -0.15, 0)
					local shineTween = TweenService:Create(Shine, TweenInfo.new(1.1, Enum.EasingStyle.Linear), {Position = UDim2.new(1.15, 0, -0.15, 0)})
					shineTween:Play()
			...
			task.spawn(function()
				while LoadGui.Parent and ProgressFill.Size.X.Scale < 0.95 do
					for _ = 1, 3 do
						...
						TweenService:Create(dot, TweenInfo.new(math.random(16, 28)/10, Enum.EasingStyle.Linear), {
							Position = UDim2.new(dot.Position.X.Scale, 0, 1.3, 0),
							BackgroundTransparency = 1
						}):Play()

						Debris:AddItem(dot, 3.5)
					end
					task.wait(0.07)
				end
			end)
...
Frame.BackgroundColor3 = Color3.fromRGB(5,5,5) -- All black
...
SliderBack.BackgroundColor3 = Color3.fromRGB(5,5,5) -- All black
...
StatusButton.BackgroundColor3 = Color3.fromRGB(5,5,5) -- black
...
Frame.BackgroundColor3 = Color3.fromRGB(5,5,5) -- black bg
...
Title.BackgroundColor3 = Color3.fromRGB(5,5,5) -- black title bg
...
ToggleButton.BackgroundColor3 = Color3.fromRGB(5,5,5) -- black bg
...
right.BackgroundColor3 = Color3.fromRGB(5,5,5)
...
UsernameBox.BackgroundColor3 = Color3.fromRGB(5,5,5)
...
FilterDropdown.BackgroundColor3 = Color3.fromRGB(5,5,5)
...
TPButton.BackgroundColor3 = Color3.fromRGB(5,5,5)
...
GrabButton.BackgroundColor3 = Color3.fromRGB(5,5,5)
...
itemBox.BackgroundColor3 = Color3.fromRGB(5,5,5)
...
amountBox.BackgroundColor3 = Color3.fromRGB(5,5,5)
...
sendButton.BackgroundColor3 = Color3.fromRGB(5,5,5)
...
buyButton.BackgroundColor3 = Color3.fromRGB(5,5,5)
...
frame.BackgroundColor3 = Color3.fromRGB(5,5,5) -- ultra black
...
oxyButton.BackgroundColor3 = Color3.fromRGB(5,5,5) -- full black
...
modeButton.BackgroundColor3 = Color3.fromRGB(5,5,5)
...
qtyBox.BackgroundColor3 = Color3.fromRGB(5,5,5)
...
moveButton.BackgroundColor3 = Color3.fromRGB(5,5,5)
...
Frame.BackgroundColor3 = Color3.fromRGB(5,5,5) -- pure black
...
AutoFarmBtn.BackgroundColor3 = Color3.fromRGB(5,5,5)
...
AutoSellBtn.BackgroundColor3 = Color3.fromRGB(5,5,5)
...
giveOnce.BackgroundColor3 = Color3.fromRGB(5,5,5)
...
addMainMenuButton("INFINITE STATS DOMINION - GOD MODE (NXS)", function()
...
local function createBoostGui()
    ...
    speedLabel.BackgroundColor3 = Color3.fromRGB(5,5,5)
    ...
    settingsPanel.BackgroundColor3 = Color3.fromRGB(5,5,5)
    ...
    resetBtn.BackgroundColor3 = Color3.fromRGB(5,5,5)
...
refreshBtn.BackgroundColor3 = Color3.fromRGB(5,5,5)
...
Button.BackgroundColor3 = Color3.fromRGB(5,5,5) -- black button
...
ToggleButton.BackgroundColor3 = Color3.fromRGB(5,5,5) -- Black
...
HeadToggleButton.BackgroundColor3 = Color3.fromRGB(5,5,5)
...
AimToggleButton.BackgroundColor3 = Color3.fromRGB(5,5,5)
...
modeDropdown.BackgroundColor3 = Color3.fromRGB(5,5,5)
...
smoothBox.BackgroundColor3 = Color3.fromRGB(5,5,5)
...
statusLabel.BackgroundColor3 = Color3.fromRGB(5,5,5)
...
main.BackgroundColor3 = Color3.fromRGB(5,5,5) -- all black
...
rightPanel.BackgroundColor3 = Color3.fromRGB(5,5,5)
...
local function createButton(remote)
    ...
    btn.MouseButton1Click:Connect(function()
        ...
        for _, b in pairs(leftScroll:GetChildren()) do
            ...
            if b:IsA("TextButton") then b.BackgroundColor3 = Color3.fromRGB(5,5,5) end
