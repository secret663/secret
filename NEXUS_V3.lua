...
local function showTab(name)
	...
	if divider then divider.BackgroundColor3 = Color3.fromRGB(15,15,15) end

	if ring then ring.BackgroundColor3 = Color3.fromRGB(15,15,15) end
...
local topTabNames = {
	...
	"NEXUS V3", "THE BILLIONARE", "RP TELEPORT", "ADMIN PANEL", "REMOTES", "ANTI CHEAT"
