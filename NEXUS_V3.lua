...
local function onKeySubmit()
	...
	if keyBox.Text == CorrectKey then
		...
		errorLbl.Text = "X Wrong key! Try again."
...
if not storageSystem then
    ...
    warn("X 'StorageSystem' not found in ReplicatedStorage.")
...
print("OK StorageSystem Tools Viewer loaded (Press O to toggle, click to copy).")
...
local lastCamCFrame -- OK store final freecam position
...
local function toggleFreecam()
	...
	if enabled then
		...
		-- OK Save final camera position before restoring
		...
		-- OK Teleport character where freecam stopped
...
if not ok then
    ...
    lbl.Text = "X Admin Panel not found in this game!"
    lbl.Font = Enum.Font.GothamBold
    lbl.TextSize = 13
    lbl.Parent = f
    task.wait(3)
...
addLog("OK NEXUS REMOTE SPY LOADED (WHITELIST MODE)")
