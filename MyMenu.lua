...
InputBG.Position = UDim2.new(0, 15, 0, 115)
...
SubmitBtn.Position = UDim2.new(0, 15, 0, 162)
...
TitleBar.InputBegan:Connect(function(input)
    if input.UserInputType == Enum.UserInputType.MouseButton1
        ...
        winStartX = Window.Position.X.Offset
        winStartY = Window.Position.Y.Offset
    end
end)
...
UserInputService.InputChanged:Connect(function(input)
    ...
    local newX = math.clamp(winStartX + deltaX, 0, screenSize.X - Window.AbsoluteSize.X)
    local newY = math.clamp(winStartY + deltaY, 0, screenSize.Y - Window.AbsoluteSize.Y)
