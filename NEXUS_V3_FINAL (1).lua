...
local themes = {
	...
	WHITE = {primary = Color3.fromRGB(255,255,255), accent = Color3.fromRGB(25,25,25)},
	...
	GRAY  = {primary = Color3.fromRGB(255,255,255), accent = Color3.fromRGB(25,25,25)},
...
if allTabButtons[1] then
	...
	allTabButtons[1].BackgroundColor3 = Color3.fromRGB(20,20,20)
...
addMainMenuButton("INFINITE STATS DOMINION (NXS)", function()
...
UserInputService.InputBegan:Connect(function(i, gp)
	...
	if i.KeyCode == toggleKey then
		...
		if screenGui.Enabled then
			...
			for _, b in ipairs(allTabButtons) do b.BackgroundColor3 = Color3.fromRGB(18,18,18) end

			if allTabButtons[1] then allTabButtons[1].BackgroundColor3 = Color3.fromRGB(20,20,20) end
