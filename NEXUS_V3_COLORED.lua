...
local themes = {
	...
	WHITE = {primary = Color3.fromRGB(0,0,0), accent = Color3.fromRGB(200,200,200)},
...
new("UIStroke", {Color = Color3.fromRGB(38, 38, 38), Thickness = 1, Parent = main})

-- Falling dots effect
local function spawnFallingDot()
	local sizes = {3, 4, 5}
	local s = sizes[math.random(1, #sizes)]
	local startX = math.random(0, 100) / 100
	local dot = Instance.new("Frame")
	dot.Size = UDim2.new(0, s, 0, s)
	dot.Position = UDim2.new(startX, 0, -0.05, 0)
	...
	TweenService:Create(dot, TweenInfo.new(math.random(30, 70)/10, Enum.EasingStyle.Linear), {
		Position = UDim2.new(startX, 0, 1.05, 0),
		BackgroundTransparency = 0.85,
	}):Play()
	task.delay(7, function() dot:Destroy() end)
end
task.spawn(function()
	while true do
...
new("UICorner", {CornerRadius = UDim.new(0, 10), Parent = headerBar})
...
local headerTitle = new("TextLabel", {
	...
	Text = "NEXUS V3  --  discord.gg/NPPFejD8y",
...
new("UICorner", {CornerRadius = UDim.new(0, 10), Parent = leftPanel})
local leftFill = new("Frame", {
...
local categories = {
	"MAIN", "ROLEPLAY", "ROLEPLAY 2", "LATEST",
	"BRING", "AIMBOT", "SCRIPTS", "CASH", "PLAYERS",
	"NEXUS", "BILLIONARE", "TP MENU", "ADMIN", "REMOTES",
	"ANTI CHEAT", "PLAYER LIST", "SETTINGS", "EXECUTOR"
}

local categoryMap = {
	["MAIN"] = "MAIN MENU",
	["ROLEPLAY"] = "ROLEPLAY MENU",
	["ROLEPLAY 2"] = "ROLEPLAY MENU 2",
...
local function showTab(name)
	for tabName, panel in pairs(allTabPanels) do
		panel.Visible = (tabName == name)
	end
	currentTab = name
end

local function createCategoryBtn(shortName)
	local fullName = categoryMap[shortName] or shortName
	...
	allTabPanels[fullName] = panel

	btn.MouseButton1Click:Connect(function()
		showTab(fullName)
		if currentCategoryBtn then
			currentCategoryBtn.BackgroundColor3 = Color3.fromRGB(25, 25, 25)
			currentCategoryBtn.TextColor3 = Color3.fromRGB(180, 180, 180)
		end
	...
	btn.MouseEnter:Connect(function()
		if currentCategoryBtn ~= btn then
...
for _, cat in ipairs(categories) do
	createCategoryBtn(cat)
end

-- Select first tab by default
if allTabButtons[1] then
	allTabButtons[1].BackgroundColor3 = Color3.fromRGB(38, 38, 38)
	allTabButtons[1].TextColor3 = Color3.fromRGB(255, 255, 255)
	currentCategoryBtn = allTabButtons[1]
end
showTab("MAIN MENU")
...
local currentTheme = "WHITE"
local themes = {
	WHITE = {primary = Color3.fromRGB(220,220,220), accent = Color3.fromRGB(200,200,200)},
	RED   = {primary = Color3.fromRGB(220,220,220), accent = Color3.fromRGB(255,50,50)},
	BLUE  = {primary = Color3.fromRGB(220,220,220), accent = Color3.fromRGB(50,150,255)},
	GRAY  = {primary = Color3.fromRGB(220,220,220), accent = Color3.fromRGB(150,150,150)},
	PINK  = {primary = Color3.fromRGB(220,220,220), accent = Color3.fromRGB(255,100,200)},
}
local function applyTheme() end -- placeholder

-- Button creator for all tabs
local function addMainMenuButton(text, callback)
	...
	new("UICorner", {CornerRadius = UDim.new(0, 6), Parent = btn})
	new("UIStroke", {Color = Color3.fromRGB(38, 38, 38), Thickness = 1, Parent = btn})
	btn.MouseEnter:Connect(function()
...
title.TextColor3 = Color3.fromRGB(220,220,220) -- White
...
inputBox.PlaceholderText = "Enter Music ID [3NEXUS]"
...
toggleButton.TextColor3 = Color3.fromRGB(220,220,220) -- White
...
addMainMenuButton("LOOP BRING ALL [3NEXUS]", function()
...
StatusButton.TextColor3 = Color3.fromRGB(220,220,220) -- white text
...
StatusButton.MouseButton1Click:Connect(function()
    ...
    if loopEnabled then
        ...
        StatusButton.TextColor3 = Color3.fromRGB(220,220,220) -- green text
        ...
        StatusButton.TextColor3 = Color3.fromRGB(220,220,220) -- back to white text
...
ScanButton.BackgroundColor3 = Color3.fromRGB(15,15,15)
...
local function CreatePlayerButton(player)
	...
	PlayerButton.BackgroundColor3 = Color3.fromRGB(18, 18, 18)
...
Title.TextColor3 = Color3.fromRGB(220,220,220) -- white text
...
ToggleButton.TextColor3 = Color3.fromRGB(220,220,220) -- red text (off)
...
ToggleButton.MouseButton1Click:Connect(function()
    ...
    if AimViewerEnabled then
        ...
        ToggleButton.TextColor3 = Color3.fromRGB(220,220,220) -- green kapag on

    else

        ToggleButton.Text = "Aim Viewer: OFF"

        ToggleButton.TextColor3 = Color3.fromRGB(220,220,220) -- red kapag off
...
PlayerList.TextColor3 = Color3.fromRGB(220,220,220)
...
FilterDropdown.TextColor3 = Color3.fromRGB(220,220,220)
...
GrabButton.TextColor3 = Color3.fromRGB(220,220,220)
...
local function addRoleplayButton(text, callback)
...
addMainMenuButton("STORAGE SYSTEM VIEWER FOR ALL CITY (NEXUS)", function()
...
addMainMenuButton("BAGONG BARYO OPEN THIS + BUY ITEM REMOTE (NEXUS)", function()
...
addMainMenuButton("BUYITEM REMOTE FOR ALL CITY (NEXUS)", function()
...
itemBox.TextColor3 = Color3.fromRGB(220,220,220)
...
amountBox.TextColor3 = Color3.fromRGB(220,220,220)
...
sendButton.MouseEnter:Connect(function()
	...
	sendButton.BackgroundColor3 = Color3.fromRGB(12, 12, 12)
...
addMainMenuButton("GUNSHOP REMOTE FOR ALL CITY (NEXUS)", function()

    -- LocalScript: NEXUS CASH MENU (GunShop Purchase System)
...
buyButton.MouseEnter:Connect(function()
	...
	buyButton.BackgroundColor3 = Color3.fromRGB(12, 12, 12)
...
titleLabel.TextColor3 = Color3.fromRGB(220,220,220) -- White instead of red
...
textBox.PlaceholderText = "Enter Command (3NEXUS)"
...
toggleButton.TextColor3 = Color3.fromRGB(220,220,220) -- White when OFF
...
addMainMenuButton("URBAN DECAY RP (NEXUS)", function()
...
titleLabel.TextColor3 = Color3.fromRGB(220,220,220) -- Changed from red to white
...
toggleButton.TextColor3 = Color3.fromRGB(220,220,220) -- Changed from red to white
...
addMainMenuButton("LICENCE GIVER SYSTEM (NEXUS)", function()
...
addMainMenuButton("PROMINENCE CITY S1 SPAWN GUN (NEXUS)", function()
...
addMainMenuButton("URBAN CITY SPAWN GUN V3 (NEXUS)", function()
...
local function addRoleplay2Button(text, callback)
...
addMainMenuButton("BAGONG BARYO SPAWNCAR (NEXUS)", function()
...
addMainMenuButton("BAGONG BARYO REFRESH (NEXUS)", function()
...
title.TextColor3 = Color3.fromRGB(220,220,220)               -- BLACK TEXT
...
refreshButton.TextColor3 = Color3.fromRGB(220,220,220)                    -- BLACK TEXT
...
addMainMenuButton("THE BILLIONARE CITY AUTO OXY (NEXUS)", function()
...
oxyButton.TextColor3 = Color3.fromRGB(220,220,220)
...
addMainMenuButton("BAGONG BARYO REFRESH WAYPOINT (NEXUS)", function()
...
local function createButton(text, order)
    ...
    button.TextColor3 = Color3.fromRGB(220,220,220)                    -- BLACK TEXT
...
addMainMenuButton("CAVITE ROLEPLAY BLACK MARKET (NEXUS)", function()
...
amountBox.PlaceholderText = "Enter Amount (NEXUS CMD)"
...
addMainMenuButton("SPAWN EVOX DOMINION HP (NEXUS)", function()
...
addMainMenuButton("DOMINION STORAGE SYSTEM MOVE (NEXUS)", function()
...
qtyLabel.TextColor3 = Color3.fromRGB(220,220,220)
...
qtyBox.TextColor3 = Color3.fromRGB(220,220,220)

qtyBox.BackgroundColor3 = Color3.fromRGB(15,15,15)

qtyBox.BorderSizePixel = 1

qtyBox.BorderColor3 = Color3.fromRGB(45, 45, 45)
...
moveButton.TextColor3 = Color3.fromRGB(220,220,220)
...
addMainMenuButton("URBAN CITY V3 AUTO OXY (NEXUS)", function()
...
addMainMenuButton("BUHAY BARANGAY RP (NEXUS)", function()
...
addMainMenuButton("KALYEONSE SPAWN GUN (NEXUS)", function()
...
addMainMenuButton("DOMINION REFRESH CLICK 2 TIMES TO REFRESH (NEXUS)", function()
...
addMainMenuButton("AUTO FARM DOMINION BRICK (NEXUS)", function()
...
addMainMenuButton("PINOY DARK RP (NEXUS)", function()
...
addMainMenuButton("GIVE ALL CASH 10M (NEXUS)", function()
...
addMainMenuButton("BUY GUNSHOP LIST (NEXUS)", function()
...
addMainMenuButton("CAVITE ROLEPLAY (NEXUS)", function()
...
addMainMenuButton("BAGONG BARYO SKIN W SOUND (NEXUS)", function()
...
addMainMenuButton("VENERAL CITY RP (NEXUS)", function()
...
amountBox.PlaceholderText = "Enter amount (3NEXUS CMD)"
...
giveOnce.TextColor3 = Color3.fromRGB(220,220,220)
...
addMainMenuButton("BAGONG BARYO LIST (NEXUS)", function()
...
local function addLatestButton(text, callback)
...
addMainMenuButton("INFINITE STATS DOMINION (NEXUS)", function()
...
frame.BackgroundColor3 = Color3.new(0, 0, 0) -- PURE BLACK
...
local function createToggle(name, posY, statName)
    ...
    label.TextColor3 = Color3.fromRGB(220,220,220) -- WHITE
    ...
    toggleFrame.BackgroundColor3 = Color3.new(0.1, 0.1, 0.1) -- DARK GRAY (OFF)
    ...
    toggleButton.BackgroundColor3 = Color3.new(0.3, 0.3, 0.3) -- GRAY (OFF)
    ...
    toggleFrame.InputBegan:Connect(function(input)
        ...
        if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then
            ...
            if enabled then
                ...
                toggleButton.BackgroundColor3 = Color3.new(0, 0.8, 0) -- GREEN (ON)

                toggleFrame.BackgroundColor3 = Color3.new(0, 0.2, 0) -- DARK GREEN

                label.TextColor3 = Color3.new(0, 1, 0) -- GREEN TEXT
                ...
                label.TextColor3 = Color3.fromRGB(220,220,220) -- WHITE TEXT
            ...
            if enabled then
                ...
                connection = RunService.Heartbeat:Connect(function()
                    ...
                    local args = { statName, Instance.new("Tool", nil) }
...
createToggle("INFINITE HEALTH", 56, "Health")

createToggle("INFINITE ARMOR", 100, "Armor")
...
close.BackgroundColor3 = Color3.new(0, 0, 0) -- BLACK

close.BorderSizePixel = 1

close.BorderColor3 = Color3.new(0.3, 0.3, 0.3)

close.Text = "X"

close.TextColor3 = Color3.fromRGB(220,220,220) -- WHITE
...
addMainMenuButton("MANUAL COMSERVE DOMINION WAIT 4 SEC (NEXUS)", function()
...
addMainMenuButton("BAGONG BARYO CONFISCATE GUI (NEXUS)", function()
...
addMainMenuButton("AFK COMSERV BETA TEST (NEXUS)", function()
...
local function createToggle(name, posY, toggleVar)
	...
	label.TextColor3 = Color3.fromRGB(220,220,220)            -- BLACK TEXT
...
close.TextColor3 = Color3.fromRGB(220,220,220)                -- BLACK TEXT
...
addMainMenuButton("JOB BOX FARM UNIVERSAL (NEXUS)", function()
...
instantButton.TextColor3 = Color3.fromRGB(220,220,220)            -- BLACK TEXT
...
pickUpButton.TextColor3 = Color3.fromRGB(220,220,220)             -- BLACK TEXT
...
dropButton.TextColor3 = Color3.fromRGB(220,220,220)               -- BLACK TEXT
...
addMainMenuButton("UNIVERSAL NO FALL DAMAGE (NEXUS)", function()
...
addMainMenuButton("CAR BOOSTER / B TO BOOST / J TO OPEN SETTINGS (NEXUS)", function()
...
addMainMenuButton("URBAN CITY REVAMPED CONFISCATE GUI (NEXUS) ", function()
...
addMainMenuButton("DOMINION CITY BANK GUI (NEXUS)", function()
...
TitleLabel.TextColor3 = Color3.fromRGB(220,220,220)          -- BLACK TEXT
...
CloseBtn.TextColor3 = Color3.fromRGB(220,220,220)            -- BLACK
...
AmountLabel.TextColor3 = Color3.fromRGB(220,220,220)         -- BLACK
...
AmountBox.TextColor3 = Color3.fromRGB(220,220,220)           -- BLACK TEXT
...
IDLabel.TextColor3 = Color3.fromRGB(220,220,220)             -- BLACK
...
IDBox.TextColor3 = Color3.fromRGB(220,220,220)               -- BLACK TEXT
...
for i, mode in ipairs(modes) do
    ...
    btn.TextColor3 = Color3.fromRGB(220,220,220)             -- BLACK TEXT
...
ExecuteBtn.TextColor3 = Color3.fromRGB(220,220,220)           -- BLACK TEXT
...
addMainMenuButton("SILENT AIM BIGHEAD UNIVERSAL (NEXUS)", function()
...
addMainMenuButton("BAGONG BARYO AFK COMSERV (NEXUS)", function()
...
local function addBringButton(text, callback)
...
addMainMenuButton("CARRY SYSTEM BRING ALL 1 (NEXUS)", function()
...
titleLabel.Text = "NEXUS CMD"

titleLabel.Font = Enum.Font.GothamBold

titleLabel.TextColor3 = Color3.fromRGB(220,220,220) -- White na
...
commands["Secret"] = function()
	...
	chatService:FireServer("NEXUS BALABAGKUMANTOT", "All")
...
toggleButton.MouseButton1Click:Connect(function()
	...
	if isOn then
		...
		toggleButton.TextColor3 = Color3.fromRGB(220,220,220) -- Green ON
		...
		toggleButton.TextColor3 = Color3.fromRGB(220,220,220) -- White OFF
...
addMainMenuButton("CARRY SYSTEM BRING ALL 2 (NEXUS)", function()
...
toggleButton.MouseButton1Click:Connect(function()
	...
	if isOn then
		...
		toggleButton.TextColor3 = Color3.fromRGB(220,220,220) -- Changed OFF color to white
...
local function addAimbotButton(text, callback)
...
addMainMenuButton("ALADIA AIMBOT VERSION 2 (NEXUS)", function()
...
FOVToggleButton.TextColor3 = Color3.fromRGB(220,220,220)
...
AimbotToggleButton.TextColor3 = Color3.fromRGB(220,220,220)
...
addMainMenuButton("AIMBOT SUPPORTED CELLPHONE (NEXUS)", function()
...
local function addScriptButton(text, callback)
...
addMainMenuButton("BACKDOOR SCANNER (NEXUS)", function()
...
addMainMenuButton("BRING PART (NEXUS)", function()
...
addMainMenuButton("CLIENT SPAWNER (NEXUS)", function()
...
addMainMenuButton("ADMIN TROLL (NEXUS)", function()
...
addMainMenuButton("FLING SELECT (NEXUS)", function()
...
addMainMenuButton("JERK (NEXUS)", function()
...
addMainMenuButton("CHAT TROLL (NEXUS)", function()
...
addMainMenuButton("SHY GUY (NEXUS)", function()
...
addMainMenuButton("AIMBOT V2 (NEXUS)", function()
...
addMainMenuButton("V1 TROLL (NEXUS)", function()
...
addMainMenuButton("V2 TROLL (NEXUS)", function()
...
addMainMenuButton("ADONIS BYPASS CP (NEXUS)", function()
...
addMainMenuButton("CLIENT BRING  (NEXUS)", function()
...
addMainMenuButton("PRESS Q TO FREECAM (NEXUS)", function()
...
local function addCashButton(text, callback)
...
addMainMenuButton("KALYE ONSE (NEXUS)", function()
...
addMainMenuButton("TONDO ROLEPLAY (NEXUS)", function()
...
addMainMenuButton("THE BILLIONARE CITY (NEXUS)", function()
...
cashButton.TextColor3 = Color3.fromRGB(220,220,220)  -- Black text
...
toggleFrame.InputBegan:Connect(function(input)
	...
	if input.UserInputType == Enum.UserInputType.MouseButton1 then
		...
		if isOn then
			...
			toggleFrame.BackgroundColor3 = Color3.fromRGB(40,40,40)  -- Light gray when ON
...
addMainMenuButton("PROMINENCE CITY S1 (NEXUS)", function()
...
addMainMenuButton("URBAN CITY V3 (NEXUS)", function()
...
local function addPlayerButton(text, callback)
...
addMainMenuButton("USERNAME COPIER (NEXUS)", function()
...
addMainMenuButton("TRACK ALL MUSCLE T TO OPEN / OFF (NEXUS)", function()
...
addMainMenuButton("ESP (NEXUS)", function()
...
local function addNexusButton(text, callback)
...
addMainMenuButton("FPS BOOST CARTOON (NEXUS)", function()
...
Button.TextColor3 = Color3.fromRGB(220,220,220) -- white text
...
addMainMenuButton("LASPINAS SYSTEM (NEXUS)", function()
...
title.Text = "NEXUS VENERAL ROLEPLAY"
...
addMainMenuButton("ADJUSTABLE BIG HEAD (NEXUS)", function()
...
addMainMenuButton("PERSIONAL SCRIPT FOR (NEXUS)", function()
...
HeadToggleButton.TextColor3 = Color3.fromRGB(220,220,220)
...
AimToggleButton.TextColor3 = Color3.fromRGB(220,220,220)
...
addMainMenuButton("FREECAM TELEPORT PRESS Q (NEXUS)", function()
...
addMainMenuButton("CASH DROP (NEXUS)", function()

	-- NEXUS CASH DROP — FULL WHITE THEME + BLACK TEXT
...
userBox.TextColor3 = Color3.fromRGB(220,220,220)
...
modeDropdown.TextColor3 = Color3.fromRGB(220,220,220)
...
addMainMenuButton("BAGONG BARYO CITY (NEXUS)", function()
...
local function addBillionareButton(text, callback)
...
addMainMenuButton("THE BILLIONARE CITY SPAWN GUN (NEXUS)", function()
...
autoBuy.TextColor3 = Color3.fromRGB(220,220,220)
...
addMainMenuButton("THE BILLIONARE CITY SPAWN CASH (NEXUS)", function()
...
addMainMenuButton("THE BILLIONARE CITY REFRESH (NEXUS)", function()
...
addMainMenuButton("THE BILLIONARE CITY SPAWN GUI (NEXUS)", function()

	-- LocalScript: NEXUS — Buy Tool (Super Compact White GUI)
...
addMainMenuButton("THE BILLIONARE CITY SPAM SOUND (NEXUS)", function()
...
local function addAdminButton(text, callback)
...
local whitelist = {
    ...
    [player.UserId] = true -- OPTIONAL: auto allow self
...
local panel = player:WaitForChild("PlayerGui"):WaitForChild("ExtraUI"):WaitForChild("AdminPanel")

panel.Transparency = 0.1

panel.Visible = false -- default hidden



--// ONLY ALLOWED CAN USE

if not whitelist[player.UserId] then

    warn("ACCESS DENIED: You are not whitelisted.")
...
addMainMenuButton("KILL ALL ONLY WHITELISTED CAN USE THIS ! ", function()
...
local whitelist = {
    ...
    [player.UserId] = true  -- Auto-include ang sarili mo (safe)
...
if not whitelist[player.UserId] then
    ...
    warn("Access denied: User not whitelisted.")

    return -- Hihinto ang script kung hindi whitelisted
...
local function addRemotesButton(text, callback)
...
local function createButton(remote)
    ...
    btn.MouseButton1Click:Connect(function()
        ...
        for _, b in pairs(leftScroll:GetChildren()) do
            ...
            if b:IsA("TextButton") then b.BackgroundColor3 = Color3.fromRGB(15,15,15) end
		...
		if plr ~= player then
			...
			local function makeMiniBtn(text, callback)
				...
				local b = new("TextButton", {
					...
					BackgroundColor3 = Color3.fromRGB(32, 32, 32), -- light gray button
...
UserInputService.InputBegan:Connect(function(i, gp)
	...
	if i.KeyCode == toggleKey then
		...
		if screenGui.Enabled then
			...
			for _, b in ipairs(allTabButtons) do b.BackgroundColor3 = Color3.fromRGB(22, 22, 22) end

			if allTabButtons[1] then allTabButtons[1].BackgroundColor3 = Color3.fromRGB(40,40,40) end
...
-- ANTI CHEAT TAB
----------------------------------------------------------------
local antiCheatPanel = allTabPanels["ANTI CHEAT"]

local acTitle = new("TextLabel", {
	Parent = antiCheatPanel,
	Size = UDim2.new(1, 0, 0, 30),
	Position = UDim2.new(0, 0, 0, 0),
	BackgroundTransparency = 1,
	Text = "ANTI CHEAT DESTROYER",
	Font = Enum.Font.GothamBold,
	TextSize = 15,
	TextColor3 = Color3.fromRGB(220, 220, 220),
	TextXAlignment = Enum.TextXAlignment.Left,
...
local function destroyMorrix()
	local count = 0
	for _, obj in ipairs(game:GetDescendants()) do
		if obj.Name:lower():find("morrix") then
			pcall(function()
				obj:Destroy()
				count += 1
				acDestroyed += 1
...
local acBtn = new("TextButton", {
	Parent = antiCheatPanel,
	Size = UDim2.new(1, 0, 0, 40),
	Position = UDim2.new(0, 0, 0, 60),
	BackgroundColor3 = Color3.fromRGB(25, 25, 25),
	Text = "START ANTI CHEAT",
	Font = Enum.Font.GothamBold,
	TextSize = 13,
	TextColor3 = Color3.fromRGB(220, 220, 220),
})
new("UICorner", {CornerRadius = UDim.new(0, 8), Parent = acBtn})
new("UIStroke", {Color = Color3.fromRGB(50, 50, 50), Thickness = 1, Parent = acBtn})

local acTotalLabel = new("TextLabel", {
	Parent = antiCheatPanel,
	Size = UDim2.new(1, 0, 0, 20),
	Position = UDim2.new(0, 0, 0, 108),
	BackgroundTransparency = 1,
	Text = "Total destroyed: 0",
	Font = Enum.Font.Gotham,
	TextSize = 12,
	TextColor3 = Color3.fromRGB(100, 100, 100),
	TextXAlignment = Enum.TextXAlignment.Left,
...
acBtn.MouseButton1Click:Connect(function()
	...
	if acRunning then
		acBtn.Text = "STOP ANTI CHEAT"
		acBtn.BackgroundColor3 = Color3.fromRGB(35, 20, 20)
		acStatus.Text = "Status: Running..."
		acStatus.TextColor3 = Color3.fromRGB(100, 200, 100)

		-- Initial scan
		destroyMorrix()
		acTotalLabel.Text = "Total destroyed: " .. acDestroyed

		-- Continuous scan
		acConn = game:GetService("RunService").Heartbeat:Connect(function()
			local found = destroyMorrix()
			if found > 0 then
				acTotalLabel.Text = "Total destroyed: " .. acDestroyed
				acStatus.Text = "Blocked " .. found .. " Morrix object(s)!"
				acStatus.TextColor3 = Color3.fromRGB(100, 220, 100)
			end
		end)

		-- DescendantAdded hook
		game.DescendantAdded:Connect(function(obj)
			if acRunning and obj.Name:lower():find("morrix") then
				pcall(function()
					obj:Destroy()
					acDestroyed += 1
					acTotalLabel.Text = "Total destroyed: " .. acDestroyed
					acStatus.Text = "Blocked Morrix: " .. obj.Name
					acStatus.TextColor3 = Color3.fromRGB(100, 220, 100)
				end)
			end
		end)
	else
		acBtn.Text = "START ANTI CHEAT"
		acBtn.BackgroundColor3 = Color3.fromRGB(25, 25, 25)
		acStatus.Text = "Status: Stopped"
		acStatus.TextColor3 = Color3.fromRGB(100, 100, 100)
