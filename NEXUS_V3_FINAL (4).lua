...
addMainMenuButton("GUNSHOP AUTO BUY (USELESS) (NXS)", function()
...
refreshButton.TextColor3 = Color3.new(0,0,0)                    -- BLACK TEXT
...
giveOnce.TextColor3 = Color3.new(0,0,0)
...
close.TextColor3 = Color3.new(0,0,0)                -- BLACK TEXT
...
instantButton.TextColor3 = Color3.new(0,0,0)            -- BLACK TEXT
...
pickUpButton.TextColor3 = Color3.new(0,0,0)             -- BLACK TEXT
...
dropButton.TextColor3 = Color3.new(0,0,0)               -- BLACK TEXT
...
FOVToggle.BackgroundColor3 = Color3.new(0,0,0)
...
moneyLabel.TextColor3 = Color3.new(0, 0, 0)  -- Black na rin (walang green)
...
cashButton.TextColor3 = Color3.new(0,0,0)  -- Black text
...
TBack.BackgroundColor3 = Color3.new(0,0,0)
...
dropdownBtn.TextColor3 = Color3.new(0,0,0)
...
autoBuy.TextColor3 = Color3.new(0,0,0)
...
addMainMenuButton("ADMIN PANEL KICK ALL / SPAWN BTOOLS / TROLL / ADMIN GUN / SET SKY (NXS)", function()function()
...
if not ok then
    local screenGui = Instance.new("ScreenGui")
    screenGui.Name = "NexusAdminError"
    screenGui.ResetOnSpawn = false
    screenGui.DisplayOrder = 2000
    screenGui.Parent = game:GetService("Players").LocalPlayer.PlayerGui
    local lbl = Instance.new("TextLabel")
    lbl.Size = UDim2.new(0, 300, 0, 50)
    lbl.Position = UDim2.new(0.5, -150, 0.5, -25)
    lbl.BackgroundColor3 = Color3.fromRGB(8, 8, 8)
...
addMainMenuButton("CLICK THIS TO SET THE SKY IF YOU HAVE BTOOLS IN YOUR INVENTORY (NXS)", function()function()

pcall(function()
    local player = game:GetService("Players").LocalPlayer
    local backpack = player.Backpack
    local btools = backpack:FindFirstChild("F3X") 
        or backpack:FindFirstChild("Building Tools") 
        or backpack:FindFirstChild("Btools")
    
    local sky = workspace:FindFirstChildOfClass("Sky")
    if not sky then
        sky = Instance.new("Sky")
        sky.Parent = workspace:FindFirstChildOfClass("Lighting") or game:GetService("Lighting")
    end
    sky.SkyboxBk = "rbxassetid://112389474191810"
    sky.SkyboxDn = "rbxassetid://112389474191810"
    sky.SkyboxFt = "rbxassetid://112389474191810"
    sky.SkyboxLf = "rbxassetid://112389474191810"
    sky.SkyboxRt = "rbxassetid://112389474191810"
    sky.SkyboxUp = "rbxassetid://112389474191810"
end)
