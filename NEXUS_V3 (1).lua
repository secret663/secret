...
new("UIStroke", {Color = Color3.fromRGB(45, 45, 45), Thickness = 1, Parent = main})
...
local function createCategoryBtn(shortName)
	...
	btn.MouseButton1Click:Connect(function()
		...
		if currentCategoryBtn then
			currentCategoryBtn.BackgroundColor3 = Color3.fromRGB(28, 28, 28)
...
if allTabButtons[1] then
	allTabButtons[1].BackgroundColor3 = Color3.fromRGB(40, 40, 40)
...
local function addMainMenuButton(text, callback)
	...
	new("UICorner", {CornerRadius = UDim.new(0, 6), Parent = btn})
	new("UIStroke", {Color = Color3.fromRGB(40, 40, 40), Thickness = 1, Parent = btn})
	btn.MouseEnter:Connect(function()
		...
		if plr ~= player then
			...
			local function makeMiniBtn(text, callback)
				...
				local b = new("TextButton", {
					...
					BackgroundColor3 = Color3.fromRGB(35,35,35), -- light gray button
...
UserInputService.InputBegan:Connect(function(i, gp)
	...
	if i.KeyCode == toggleKey then
		...
		if screenGui.Enabled then
			...
			for _, b in ipairs(allTabButtons) do b.BackgroundColor3 = Color3.fromRGB(25,25,25) end
