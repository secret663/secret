...
if playerGui:FindFirstChild("NEXUS_GUI") then
    playerGui.NEXUS_GUI:Destroy()
end
...
local function makeLine(yPos, thick, alpha)
    new("Frame", {
        Size = UDim2.new(1,0,0,thick or 1),
        Position = UDim2.new(0,0,yPos,0),
        BackgroundColor3 = Color3.new(1,1,1),
        BackgroundTransparency = alpha or 0.6,
        BorderSizePixel = 0,
        ZIndex = 23,
        Parent = LoadFrame,
    })
...
local BarBG = new("Frame", {
    ...
    Position = UDim2.new(0.2,0,0.76,0),
...
local PctLabel = new("TextLabel", {
    ...
    Position = UDim2.new(0.2,0,0.80,0),
    BackgroundTransparency = 1,
...
local function addMainMenuButton(text, callback)
	...
	local panel = allTabPanels["NEXUS MENU"]
...
-- Hide main GUI until loading done
screenGui.Enabled = false
