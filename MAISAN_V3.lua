...
-- Decorative white dots (fixed positions, katulad ng RAZE MENU)
local dotData = {
	{x = 0.18, y = 0.13, s = 4},
	{x = 0.55, y = 0.08, s = 3},
	{x = 0.72, y = 0.22, s = 5},
...
for _, d in ipairs(dotData) do
	local dot = new("Frame", {
		...
		Position = UDim2.new(d.x, 0, d.y, 0),
...
new("TextLabel", {
	...
	Text = "MAISAN V3  --  discord.gg/maisan",
...
local topTabNames = {
	...
	"MAISAN V3", "THE BILLIONARE", "RP TELEPORT", "ADMIN PANEL", "REMOTES"
...
addMainMenuButton("INFINITE YIELD (MAISAN)", function()
...
addMainMenuButton("MUSIC EXPLOITS (MAISAN)", function()

	-- MAISAN CMD - Minimal FE Audio Player (White Font Update)
...
inputBox.PlaceholderText = "Enter Music ID [3MAISAN]"
...
addMainMenuButton("ESP PLAYER (MAISAN)", function()
...
addMainMenuButton("BIG HEAD PLAYER (MAISAN)", function()
...
addMainMenuButton("KEYBIND Q TO FREECAM (MAISAN)", function()
...
addMainMenuButton("AIMBOT ADJUSTABLE (MAISAN)", function()
...
addMainMenuButton("FADED GUI UNIVERSAL (MAISAN)", function()
...
addMainMenuButton("LOOP BRING ALL [3MAISAN]", function()
...
addMainMenuButton("PLAYER SCANNER (MAISAN)", function()

	--// MAISAN PLAYER SCANNER
...
addMainMenuButton("AIM VIEWER (MAISAN)", function()
...
addMainMenuButton("HEAD DETECTOR (MAISAN)", function()
...
addMainMenuButton("PLAYER LIST TP (MAISAN)", function()

	-- MAISAN - Player Viewer (LocalScript sa StarterGui)
...
addMainMenuButton("TPUNANCHORED TO PLAYER (MAISAN)", function()
...
addMainMenuButton("FLING ALL (MAISAN)", function()
...
addMainMenuButton("HITBOX EXTENDER (MAISAN)", function()
...
addMainMenuButton("STORAGE SYSTEM VIEWER FOR ALL CITY (MAISAN)", function()
...
addMainMenuButton("BAGONG BARYO OPEN THIS + BUY ITEM REMOTE (MAISAN)", function()
...
addMainMenuButton("BUYITEM REMOTE FOR ALL CITY (MAISAN)", function()
...
addMainMenuButton("GUNSHOP REMOTE FOR ALL CITY (MAISAN)", function()

    -- LocalScript: MAISAN CASH MENU (GunShop Purchase System)
...
textBox.PlaceholderText = "Enter Command (3MAISAN)"
...
addMainMenuButton("URBAN DECAY RP (MAISAN)", function()
...
addMainMenuButton("LICENCE GIVER SYSTEM (MAISAN)", function()
...
addMainMenuButton("PROMINENCE CITY S1 SPAWN GUN (MAISAN)", function()
...
addMainMenuButton("URBAN CITY SPAWN GUN V3 (MAISAN)", function()
...
addMainMenuButton("BAGONG BARYO SPAWNCAR (MAISAN)", function()
...
addMainMenuButton("BAGONG BARYO REFRESH (MAISAN)", function()
...
addMainMenuButton("THE BILLIONARE CITY AUTO OXY (MAISAN)", function()
...
addMainMenuButton("BAGONG BARYO REFRESH WAYPOINT (MAISAN)", function()
...
addMainMenuButton("CAVITE ROLEPLAY BLACK MARKET (MAISAN)", function()
...
amountBox.PlaceholderText = "Enter Amount (MAISAN CMD)"
...
addMainMenuButton("SPAWN EVOX DOMINION HP (MAISAN)", function()
...
addMainMenuButton("DOMINION STORAGE SYSTEM MOVE (MAISAN)", function()
...
addMainMenuButton("URBAN CITY V3 AUTO OXY (MAISAN)", function()
...
addMainMenuButton("BUHAY BARANGAY RP (MAISAN)", function()
...
addMainMenuButton("KALYEONSE SPAWN GUN (MAISAN)", function()
...
addMainMenuButton("DOMINION REFRESH CLICK 2 TIMES TO REFRESH (MAISAN)", function()
...
addMainMenuButton("AUTO FARM DOMINION BRICK (MAISAN)", function()
...
addMainMenuButton("PINOY DARK RP (MAISAN)", function()
...
addMainMenuButton("GIVE ALL CASH 10M (MAISAN)", function()
...
addMainMenuButton("BUY GUNSHOP LIST (MAISAN)", function()
...
addMainMenuButton("CAVITE ROLEPLAY (MAISAN)", function()
...
addMainMenuButton("BAGONG BARYO SKIN W SOUND (MAISAN)", function()
...
addMainMenuButton("VENERAL CITY RP (MAISAN)", function()
...
amountBox.PlaceholderText = "Enter amount (3MAISAN CMD)"
...
addMainMenuButton("BAGONG BARYO LIST (MAISAN)", function()
...
addMainMenuButton("INFINITE STATS DOMINION (MAISAN)", function()
...
addMainMenuButton("MANUAL COMSERVE DOMINION WAIT 4 SEC (MAISAN)", function()
...
addMainMenuButton("BAGONG BARYO CONFISCATE GUI (MAISAN)", function()
...
addMainMenuButton("AFK COMSERV BETA TEST (MAISAN)", function()
...
addMainMenuButton("JOB BOX FARM UNIVERSAL (MAISAN)", function()
...
addMainMenuButton("UNIVERSAL NO FALL DAMAGE (MAISAN)", function()
...
addMainMenuButton("CAR BOOSTER / B TO BOOST / J TO OPEN SETTINGS (MAISAN)", function()
...
addMainMenuButton("URBAN CITY REVAMPED CONFISCATE GUI (MAISAN) ", function()
...
addMainMenuButton("DOMINION CITY BANK GUI (MAISAN)", function()
...
addMainMenuButton("SILENT AIM BIGHEAD UNIVERSAL (MAISAN)", function()
...
addMainMenuButton("BAGONG BARYO AFK COMSERV (MAISAN)", function()
...
addMainMenuButton("CARRY SYSTEM BRING ALL 1 (MAISAN)", function()
...
commands["Secret"] = function()
	...
	chatService:FireServer("MAISAN BALABAGKUMANTOT", "All")
...
addMainMenuButton("CARRY SYSTEM BRING ALL 2 (MAISAN)", function()
...
addMainMenuButton("ALADIA AIMBOT VERSION 2 (MAISAN)", function()
...
addMainMenuButton("AIMBOT SUPPORTED CELLPHONE (MAISAN)", function()
...
addMainMenuButton("BACKDOOR SCANNER (MAISAN)", function()
...
addMainMenuButton("BRING PART (MAISAN)", function()
...
addMainMenuButton("CLIENT SPAWNER (MAISAN)", function()
...
addMainMenuButton("ADMIN TROLL (MAISAN)", function()
...
addMainMenuButton("FLING SELECT (MAISAN)", function()
...
addMainMenuButton("JERK (MAISAN)", function()
...
addMainMenuButton("CHAT TROLL (MAISAN)", function()
...
addMainMenuButton("SHY GUY (MAISAN)", function()
...
addMainMenuButton("AIMBOT V2 (MAISAN)", function()
...
addMainMenuButton("V1 TROLL (MAISAN)", function()
...
addMainMenuButton("V2 TROLL (MAISAN)", function()
...
addMainMenuButton("ADONIS BYPASS CP (MAISAN)", function()
...
addMainMenuButton("CLIENT BRING  (MAISAN)", function()
...
addMainMenuButton("PRESS Q TO FREECAM (MAISAN)", function()
...
addMainMenuButton("LOOP BRING ALL (MAISAN)", function()
...
addMainMenuButton("KALYE ONSE (MAISAN)", function()
...
addMainMenuButton("TONDO ROLEPLAY (MAISAN)", function()
...
addMainMenuButton("THE BILLIONARE CITY (MAISAN)", function()
...
addMainMenuButton("PROMINENCE CITY S1 (MAISAN)", function()
...
addMainMenuButton("URBAN CITY V3 (MAISAN)", function()
...
addMainMenuButton("USERNAME COPIER (MAISAN)", function()
...
addMainMenuButton("TRACK ALL MUSCLE T TO OPEN / OFF (MAISAN)", function()
...
addMainMenuButton("ESP (MAISAN)", function()
...
local function addMainMenuButton(text, callback)
	...
	local panel = allTabPanels["MAISAN V3"]
...
addMainMenuButton("FPS BOOST CARTOON (MAISAN)", function()
...
addMainMenuButton("LASPINAS SYSTEM (MAISAN)", function()
...
addMainMenuButton("ADJUSTABLE BIG HEAD (MAISAN)", function()
...
addMainMenuButton("PERSIONAL SCRIPT FOR (MAISAN)", function()
...
addMainMenuButton("FREECAM TELEPORT PRESS Q (MAISAN)", function()
...
addMainMenuButton("CASH DROP (MAISAN)", function()

	-- MAISAN CASH DROP — FULL WHITE THEME + BLACK TEXT
...
addMainMenuButton("BAGONG BARYO CITY (MAISAN)", function()
...
addMainMenuButton("THE BILLIONARE CITY SPAWN GUN (MAISAN)", function()
...
addMainMenuButton("THE BILLIONARE CITY SPAWN CASH (MAISAN)", function()
...
addMainMenuButton("THE BILLIONARE CITY REFRESH (MAISAN)", function()
...
addMainMenuButton("THE BILLIONARE CITY SPAWN GUI (MAISAN)", function()

	-- LocalScript: MAISAN — Buy Tool (Super Compact White GUI)
...
addMainMenuButton("THE BILLIONARE CITY SPAM SOUND (MAISAN)", function()
...
addMainMenuButton("REMOTES ONLY FOR MAISAN ! ", function()

	-- MAISAN REMOTE SPY v3 - WITH USERNAME WHITELIST
...
addLog("✅ MAISAN REMOTE SPY LOADED (WHITELIST MODE)")
